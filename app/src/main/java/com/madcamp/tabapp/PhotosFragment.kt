    ...
    private fun initReviews() {
        val defaultReviewList = listOf(
            Review(
                ...
                writer = "민수잇",
                profileUri = "android.resource://com.madcamp.tabapp/" + R.drawable.profile_image1,
                isAdminUser = false
            ),
            Review(
                name = "여행 중 간식으로 딱!",
                ...
                writer = "여행자",
                profileUri = "android.resource://com.madcamp.tabapp/" + R.drawable.profile_image2,
                isAdminUser = false
            ),
            Review(
                name = "아늑하고 맛있는 빵집",
                ...
                writer = "달콤한하루",
                profileUri = "android.resource://com.madcamp.tabapp/" + R.drawable.profile_image3,
                isAdminUser = false
            ),
            Review(
                name = "캘리포니아의 맛",
                ...
                writer = "캘리러버",
                profileUri = "android.resource://com.madcamp.tabapp/" + R.drawable.profile_image4,
                isAdminUser = false
            ),
            Review(
                name = "전통의 맛",
                ...
                writer = "전통맛",
                profileUri = "android.resource://com.madcamp.tabapp/" + R.drawable.profile_image5,
                isAdminUser = false
            ),
            Review(
                name = "따뜻한 분위기",
                ...
                writer = "따뜻함",
                profileUri = "android.resource://com.madcamp.tabapp/" + R.drawable.profile_image6,
                isAdminUser = false
            ),
            Review(
                name = "품질 좋은 빵",
                ...
                writer = "품질우선",
                profileUri = "android.resource://com.madcamp.tabapp/" + R.drawable.profile_image7,
                isAdminUser = false
            ),
            Review(
                name = "건강한 빵",
                ...
                writer = "헬시러버",
                profileUri = "android.resource://com.madcamp.tabapp/" + R.drawable.profile_image8,
                isAdminUser = false
            ),
            Review(
                name = "고급스러운 분위기",
                ...
                writer = "고급진삶",
                profileUri = "android.resource://com.madcamp.tabapp/" + R.drawable.profile_image9,
                isAdminUser = false
            )
        )
